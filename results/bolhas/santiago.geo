...
lc      = 6.e-3*L;				// Factor for the mesh refinement
lc_wall = 1.e-4*L;				// Factor for the mesh refinement
width  = 600e-6;			// Tube width
height = 0.03 / 30;			// Tube height
...
// Points
Point(3*N+4) = {0, 0, 0, lc_wall};
Point(3*N+3) = {width, 0, 0, lc_wall};
Point(3*N+2) = {width, height, 0, 3*lc_wall};
Point(3*N+1) = {0, height, 0, 3*lc_wall};
